...
public class Ex001_Program {
    public static void main(String[] args) {
        ...
        System.out.println(w1);  //Worker@7344699f - выводится хэш-код
        System.out.println(w2);  //Worker@6b95977
        System.out.println(w3);  //Worker@7e9e5f8a

        System.out.println(w4);  //Worker@8bcc55f - не совпадает с w1 (Worker@7344699f)
